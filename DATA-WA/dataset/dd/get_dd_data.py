...
maxt = max([x[0] for x in tasks])
print(maxt)

tasks = [x  for x in tasks if x[0] > 1478005200 and x[0] < 1478005200 + 7200 ]
workers = [x  for x in workers if x[0] > 1478005200 and x[0] < 1478005200 + 7200]
